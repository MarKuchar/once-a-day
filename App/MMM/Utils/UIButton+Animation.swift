...
extension UIButton {
    ...
    @objc private func animateDownForDone(sender: UIButton) {
        animateAppBtn(sender, transform: CGAffineTransform.identity.scaledBy(x: 0.95, y: 0.95))
    }
    ...
    private func animateAppBtn(_ button: UIButton, transform: CGAffineTransform) {
        UIView.animate(withDuration: 0.5,
                       delay: 0,
                       usingSpringWithDamping: 0.5,
                       initialSpringVelocity: 3,
                       ...
                       animations: {
                        ...
                        self.backgroundColor = UIColor(red: 57/255, green: 150/255, blue: 100/255, alpha: 0)
                       })
    }
}
